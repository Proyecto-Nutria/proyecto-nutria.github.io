...
const footers = [
  {
    ...
    link: [
      'https://proyectonutria.com/feedback-helper/',
      'https://github.com/Proyecto-Nutria/resume-checker',
      'https://proyectonutria.com/otter-guides/',
      'https://github.com/Proyecto-Nutria/nutria-system-v2',
    ],
  },
  {
    description: ['Facebook', 'YouTube', 'LinkedIn', 'Twitter', 'Instagram'],
    link: [
      'https://www.facebook.com/ProyectoNutria/',
      'https://www.youtube.com/c/ProyectoNutria',
      'https://www.linkedin.com/company/proyecto-nutria',
      'https://twitter.com/ProyectoNutria',
      'https://www.instagram.com/proyectonutria/',
    ],
  },
];
        ...
        <Grid container spacing={isDesktop ? 4 : 2}>
          ...
          <Grid item xs={12} md={3}>
            <Box mr={-2} mt={-2} className={classes.textColor}>
              <div className={classes.logo}>
                ...
                <Typography variant="h6">{'Proyecto Nutria'}</Typography>
              </div>
              <Typography
              ...
              >
                {t('contact.text')}
                <Link
                  href={'mailto:contact@proyectonutria.com'}
                  variant="subtitle1"
                >
                ...
                >
                  ...
                  {isMobile && (
                    ...
                    >
                      ...
                      >
                        <strong>{t('contact.sections.' + index)}</strong>
                      </ExpansionPanelSummary>
          ...
          <Grid item xs={12} md={3}>
            <div className={classes.socmed}>
              <Link
                href="https://discord.gg/CJHxp3PZ9t"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <Link
                href="https://github.com/proyecto-nutria"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <Link
                href="https://www.notion.so/Proyecto-Nutria-4e1b2ba24d4a46188207c2ca10acea5f"
                target="_blank"
                rel="noreferrer"
              >
                <IconButton aria-label="NO" size="small">
                  <svg viewBox="0 0 120 126" className={classes.notionLogo}>
