...
import InterviewsTable from "components/Interviewer/Match/Table/InterviewsTable"
  ...
  return (
    ...
    >
      <Box
        ...
        align="center"
      >
        <Heading textAlign="center" level={4} margin="small">
          About {queryAbout.name.toString()}
        </Heading>
        <Box direction="row-responsive" fill={true} justify="between">
          <Box justify="center" align="center" margin="medium">
            <Button
              label="Resume"
              href={queryAbout.linkResume.toString()}
              target="_blank"
              size="small"
              primary
            />
          ...
          <Box justify="center" alignSelf="start" margin="medium">
            <Text size="small">
              Position:&nbsp;{queryAbout.position.toString()}
            </Text>
          </Box>
        </Box>
        <Box
        ...
        >
          <Text wordBreak="break-word">
            ...
            {queryAbout.programmingLanguages.join(", ")}
          </Text>
        </Box>
        <Heading textAlign="start" level={4} margin="small" alignSelf="start">
          Real Interviews
        </Heading>
