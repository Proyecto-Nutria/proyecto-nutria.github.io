// relay.config.js
module.exports = {
  src: "./src/FeedbackHelper", // Path to the folder containing your Reason files
  ...
  artifactDirectory: "./src/FeedbackHelper/__generated__", // The directory where all generated files will be emitted
